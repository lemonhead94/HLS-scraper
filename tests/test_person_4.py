...
class TestPerson4(unittest.TestCase):
    def setUp(self):
        self.browser = mechanicalsoup.StatefulBrowser()
        html_file = os.getcwd() + "/tests/mocks/mock_Person_4.html"
        with open(html_file) as file:
            self.browser.open_fake_page(
                page_text=file.read(),
                url="https://hls-dhs-dss.ch/de/articles/016298/2001-02-23/",
            )
    ...
    def test_get_article_publish_date(self):
        expected_publish_date = "23.02.2001"
    ...
    def test_get_article_author(self):
        expected_author = "Annelies Hüssy"
